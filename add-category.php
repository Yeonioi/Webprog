...
// TEMPORARY DEMO USER — replace with real session later
$userId = 1;

// GET selected general category (if passed)
    ...
    if ($categoryName && $generalCategoryId) {
        try {
            ...
            if ($stmt->fetch()) {
                ...
                // Insert category
                $insertSql = "
                    INSERT INTO service_categories (general_category_id, name, created_by, created_at)
                    VALUES (?, ?, ?, GETDATE());
                ";
                $stmt = $conn->prepare($insertSql);
                $stmt->execute([$generalCategoryId, $categoryName, $userId]);

                // SQL Server way to get inserted ID
                $idStmt = $conn->query("SELECT SCOPE_IDENTITY() AS id");
                $newCategoryId = $idStmt->fetch()['id'];
...
// If preselected general category exists → fetch details
...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        ...
        <form method="POST" action="add-category.php<?= $generalId ? '?general=' . $generalId : '' ?>">
            ...
            <!-- Select or Show Preselected General Category -->
            <div class="mb-6">
                ...
                <?php if ($selectedCategory): ?>
                    ...
                    <div class="flex items-center p-4 bg-gray-50 rounded-lg border border-gray-200">
                        <span class="text-3xl <?= e($selectedCategory['color']) ?> p-2 rounded-lg">
                            <?= e($selectedCategory['icon']) ?>
                        </span>
                        <div class="ml-3">
                ...
                <?php else: ?>
                    ...
                    <select name="general_category_id" required
            ...
            <div class="mb-6">
                ...
                <p class="text-xs text-gray-500 mt-2">
                    Be specific so others can easily find your service.
                </p>
            </div>
            ...
            <div class="mb-6 p-4 bg-blue-50 rounded-lg">
                ...
                <ul class="text-sm text-blue-800 space-y-1">
                    <li>• <strong>Education:</strong> SAT Tutoring, Piano Lessons</li>
                    <li>• <strong>Technology:</strong> Web Design, App Development</li>
                    <li>• <strong>Home & Garden:</strong> Deck Repair, Pool Cleaning</li>
                </ul>
            </div>
        ...
        <div class="mt-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <ol class="text-sm text-gray-600 space-y-2">
                ...
                <li>3. Other users can also use this category to add services</li>
            </ol>
        </div>
